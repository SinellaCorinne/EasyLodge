...
class PersonnaliserPage1 extends StatefulWidget {
  @override
  _PersonnaliserPage1State createState() => _PersonnaliserPage1State();
}

class _PersonnaliserPage1State extends State<PersonnaliserPage1> {
